 ...
 * @return 
   ...
   * @param message the assertion error message
   */
  static public boolean assertFalse(boolean condition, String message) {
    if(condition) {
...
/**
   ...
   * @param expected the expected value
   */
  static public boolean assertEquals(Object actual, Object expected) {
   ...
   * @param message the assertion error message
   */
  static public boolean assertEquals(String actual, String expected, String message) {
    return assertEquals((Object) actual, (Object) expected, message);
  }
   ...
   */
  static public boolean assertNotNull(Object object) {
  ...
  public static void assertNotEquals(Object actual1, Object actual2, String message) {
    boolean fail = false;
    try {
      AssertValidation.assertEquals(actual1, actual2);
      fail = true;
    } catch (AssertionError e) {
    }

    if (fail) {
      AssertValidation.fail(message);
    }
  }
  ...
  static public void assertNotEquals(float actual1, float actual2, float delta, String message) {
    boolean fail = false;
    try {
      AssertValidation.assertEquals(actual1, actual2, delta, message);
      fail = true;
    } catch (AssertionError e) {
