...
public class ValidationUtils {
  ...
  public static ProcessingReport isJsonValid1(JsonSchema jsonSchemaNode, JsonNode jsonNode)
      throws ProcessingException {
    ProcessingReport report = jsonSchemaNode.validate(jsonNode);
    return report;
  }
  
  public static ProcessingReport getjsonValReport(String schemaText, String jsonText)
  ...
  public static boolean isJsonValid1(String schemaText, String jsonText)
      throws ProcessingException, IOException {
    final JsonSchema schemaNode = getSchemaNode(schemaText);
    final JsonNode jsonNode = getJsonNode(jsonText);
